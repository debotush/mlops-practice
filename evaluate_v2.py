...
print(f"\nV1 Model Performance on Combined Data (Jan + Feb 2021):")
...
with open('results/evaluate_v2_results.txt', 'w') as f:
    f.write("V2 EVALUATION RESULTS\n")
    f.write("="*50 + "\n\n")
    f.write("Model: V1 Linear Regression (trained on Jan 2021 only)\n")
    f.write("Evaluation data: Jan + Feb 2021 combined\n\n")
...
print("\nResults saved to results/evaluate_v2_results.txt")
